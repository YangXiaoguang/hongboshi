...
describe("domain contracts", () => {
  ...
  it("maps user roles to stable permissions", () => {
    ...
    expect(userCan({ roles: ["member"] }, "audit:archive")).toBe(false);
    ...
    expect(userCan({ roles: ["operator"] }, "audit:archive")).toBe(false);
    ...
    expect(userCan({ roles: ["admin"] }, "audit:archive")).toBe(true);
  });
