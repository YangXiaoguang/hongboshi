...
export const CounselorSchema = z.object({
  ...
  trainingSummary: z.string().max(300).optional(),
  serviceStyle: z.string().max(300).optional(),
  idealClientDescription: z.string().max(300).optional(),
  yearsOfPractice: z.number().int().nonnegative(),
  caseHours: z.number().int().nonnegative().optional(),
...
export const CounselorAdminProfilePatchSchema = z
  .object({
    ...
    trainingSummary: z.string().trim().max(300).optional(),
    serviceStyle: z.string().trim().max(300).optional(),
    idealClientDescription: z.string().trim().max(300).optional(),
    yearsOfPractice: z.number().int().min(0).max(60).optional(),
    caseHours: z.number().int().min(0).max(100000).optional(),
