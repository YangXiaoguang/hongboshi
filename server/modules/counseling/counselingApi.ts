  ...
  const savedProfile = await counselorAdminProfileStore.saveProfile(
    CounselorAdminProfileConfigSchema.parse({
      counselor: {
        ...
        trainingSummary: request.profile.trainingSummary,
        serviceStyle: request.profile.serviceStyle,
        idealClientDescription: request.profile.idealClientDescription,
        yearsOfPractice: request.profile.yearsOfPractice,
        caseHours: request.profile.caseHours,
