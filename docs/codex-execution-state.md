...
- 最后更新时间：2026-06-01 Asia/Shanghai
- 当前分支：`main`
- GitHub 仓库：`https://github.com/YangXiaoguang/hongboshi.git`
- 最近已知基线提交：本轮提交后以 Git 历史最新提交为准
- 当前阶段：`M7 咨询运营增强`
- 当前状态：`M7-F 咨询师抽屉式维护与档案丰富度优化` 已完成；`/admin/counseling` 咨询师工作区保留清单 + 详情概览，新增/编辑统一进入右侧抽屉，避免长表单堆在页面底部；咨询师档案新增头像、训练背景、咨询风格、适合人群和服务小时数，保存失败改为字段级提示，并提供示例补全以降低运营录入成本。课程商品 `ADM-PRO-T-A` 暂缓，待本轮咨询运营体验稳定后继续。
- 本轮完成后下一步：执行 `M7-G 咨询师前台预览、审计详情与排班联动入口`
