...
- 接入 `/api/counseling/admin/counselors` 与 `/admin/counseling` 咨询师维护工作台，运营/管理员可在咨询师工作区维护咨询师展示资料、擅长方向、价格、执业年限、资质摘要、资质状态、资质到期时间、接单开关、接新客门禁和服务状态，并可新增咨询师、软删除名册移除；前台可预约列表会自动排除暂停接单、关闭接新客、资质待复核、资质过期或已删除的咨询师。
