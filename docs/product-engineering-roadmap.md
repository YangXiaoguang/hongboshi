...
- 接入 `/api/counseling/admin/counselors` 与 `/admin/counseling` 咨询师维护工作台，运营/管理员可在左侧清单和右侧详情面板中维护咨询师展示资料、擅长方向、价格、执业年限、资质摘要、资质状态、资质到期时间、接单开关、接新客门禁和服务状态；前台可预约列表会自动排除暂停接单、关闭接新客、资质待复核或资质过期的咨询师。
