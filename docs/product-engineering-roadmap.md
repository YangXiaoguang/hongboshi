...
- 已完成课程电商化货架主动作、列表内半屏下单、全局待支付召回和商品信任模块，课程路径、快速开始区和课程列表卡片均可直接开始学习、立即购买、开通会员或继续支付；课程中心、课程详情和成长空间可召回待支付订单并复用共享结算抽屉，课程详情页前置讲师、学习反馈、售后/隐私边界和 FAQ。
- 完成课程详情、章节、学习进度、收藏列表。
...
- 下一阶段：优惠与组合购、真实支付/退款渠道适配、结算批次、渠道结算单、对账异常处理动作、审计归档读取切换策略和留存告警可串联。
