...
- 已完成课程素材资产登记、真实文件上传与受控读取首个切片：新增课程素材资产共享契约、开发期 JSON Store、本地文件存储 adapter、后台素材读取/URL 登记/文件上传/合规处理 API 和 `/admin/courses` 素材资产库区；已通过图片可作为课程详情展示素材，已解锁用户可通过受控接口下载开启下载的学习资料，学习页资料区深度绑定留到下一步。
- 完成课程详情、章节、学习进度、收藏列表。
