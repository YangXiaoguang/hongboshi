...
- 课程详情内容：`server/modules/catalog/courseProductContentStore.ts` 负责课程摘要、适合人群、章节和素材占位；当前支持内存与 JSON 文件 Store，内容更新会写入课程商品审计并触发复审。
